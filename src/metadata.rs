...
trait MetadataSource {
    fn _load_metadata(&mut self, store: &StoreSlice) -> HashMap<ProjectId, serde_json::Map<String, JSON>> {
    ...
    fn load_metadata(&mut self, store: &StoreSlice) -> HashMap<ProjectId, serde_json::Map<String, JSON>> {
        // store.projects_metadata()
        //     .filter(|(_, meta)| meta.key == "github_metadata")
    ...
    fn load_all_from_store(&mut self, store: &StoreSlice) {
...
impl ProjectMetadataSource {
    pub fn is_fork          (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<bool>     { gimme!(self, are_forks,     store, pirate, key)           }
    pub fn is_archived      (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<bool>     { gimme!(self, are_archived,  store, pirate, key)           }
    pub fn is_disabled      (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<bool>     { gimme!(self, are_disabled,  store, pirate, key)           }
    pub fn star_gazers      (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<usize>    { gimme!(self, star_gazers,   store, pirate, key)           }
    pub fn watchers         (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<usize>    { gimme!(self, watchers,      store, pirate, key)           }
    pub fn size             (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<usize>    { gimme!(self, size,          store, pirate, key)           }
    pub fn open_issues      (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<usize>    { gimme!(self, open_issues,   store, pirate, key)           }
    pub fn forks            (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<usize>    { gimme!(self, forks,         store, pirate, key)           }
    pub fn subscribers      (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<usize>    { gimme!(self, subscribers,   store, pirate, key)           }
    pub fn license          (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<String>   { gimme!(self, licenses,      store, pirate, key)           }
    pub fn description      (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<String>   { gimme!(self, descriptions,  store, pirate, key)           }
    pub fn homepage         (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<String>   { gimme!(self, homepages,     store, pirate, key)           }
    pub fn language         (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<Language> { gimme!(self, languages,     store, pirate, key)           }
    pub fn has_issues       (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<bool>     { gimme!(self, has_issues,    store, pirate, key)           }
    pub fn has_downloads    (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<bool>     { gimme!(self, has_downloads, store, pirate, key)           }
    pub fn has_wiki         (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<bool>     { gimme!(self, has_wiki,      store, pirate, key)           }
    pub fn has_pages        (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<bool>     { gimme!(self, has_pages,     store, pirate, key)           }
    pub fn created          (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<i64>      { gimme!(self, created,       store, pirate, key)           }
    pub fn updated          (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<i64>      { gimme!(self, updated,       store, pirate, key)           }
    pub fn pushed           (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<i64>      { gimme!(self, pushed,        store, pirate, key)           }
    pub fn master           (&mut self, store: &StoreSlice, key: &ProjectId) -> Option<String>   { gimme!(self, master,        store, pirate, key)           }
}
...
impl ProjectMetadataSource {
    pub fn keys(&mut self, store: &StoreSlice) -> impl Iterator<Item=ProjectId> {
    ...
    pub fn all_metadata(&mut self, store: &StoreSlice, key: &ProjectId) -> ProjectMetadata {
        ProjectMetadata {
            id: key.clone(),
    ...
    pub fn iter<'a>(&'a mut self, store: &'a StoreSlice) -> impl Iterator<Item=ProjectMetadata> + 'a {
        self.keys(store)
